...
// Invoice class.
//this class defines the properties of an invoice
//D5249, lab 1, due 2/6/17, 200-01
public class Invoice
{
   ...
   public int PartNumber { get; set; } //precondition:none
   ...
   public int Quantity //precondition: value must be greater than 0
        //post condition: value is assigned
   {
      get
      {
   ...
   public decimal Price //precondition: value must be above or equal to 0
        //postcondition: value is asssigned
   {
      get
      {
         return priceValue;
   ...
   public override string ToString() => 
    ...
    //precondition: none
    //postcondition: class is given a tostring
} 
