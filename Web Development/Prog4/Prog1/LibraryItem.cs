...
//this class creates a library item and implements the icomparable interface in order to sort items later
...
namespace LibraryItems
{
    public abstract class LibraryItem:IComparable<LibraryItem>
    {
        ...
        : this(item.Title, item.Publisher, item.CopyrightYear, item.LoanPeriod,
              item.CallNumber) { } //used as argument
        ...
        //precondition: none
        //postcondition: returns sorted titles
        public int CompareTo(LibraryItem other)
        { return this.Title.CompareTo(other.Title); } //to satisfy icomparable interface, sorts by title
    }
}
