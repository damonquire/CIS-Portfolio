...
namespace Lab3
{
    public partial class lab3 : Form
    {
        ...
        const double SMALLPERCENTTIP = .15;//declared a constant for 15% tip rate
        const double MIDDLEPERCENTTIP = .18;//declared a constant for 18% tip rate
        const double LARGEPERCENTTIP = .20;//declared a constant for 20% tip rate
        public lab3()
        {
            InitializeComponent();
        }
